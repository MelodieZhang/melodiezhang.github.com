...
I conducted **usability testing** with some of our internal users to understand what problems they had in using the current Profile.  Also I collected **data** to get a better understanding about how people were using Profile in general.

![image](/imgs/profile/data_insights.jpg)

Key insights:
- One of the main actions people did on Profile was navigating through different **content tabs**, but the current interaction was not efficient.
- The **"follow" button** was small and hard to find. There were a lot of distracting elements around it.
- People **scan** most of the information on the page, but they found it difficult to identify most valuable information efficiently.

### Card Sorting
I did **card sorting** with 6 users to learn how people understood the existing information on Profile. After that, I asked users to **prioritize** what information mattered to them most when they looked at another user's profile.
...
Based on what I learned from the card sorting, I divided existing Profile down into **5 main modules**.

![image](/imgs/profile/modules.jpg)

I organized these modules to explore different possibilities based on the priority of the information.
![image](/imgs/profile/wireframe.png)
