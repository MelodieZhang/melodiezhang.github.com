...
## A Massive Project. How Should We Start?
...
After listening to voices from different perspectives, I found a big match between user problems and inside stakeholder concerns.
...
Inspired by the insights from wireframe phase, I started to do some  experimentations with **higher fidelity prototypes** to get a more tangible feeling about each possibility. I mainly focused on improving the clarity of existing content:

![image](/imgs/profile/iteration1.jpg)

My key design decisions and solutions on this stage:
...
In order to validate my explorations, I printed these prototypes and put them on the passage wall of the office where people could stop by and take a look. We created a Slack channel and collected lots of feedback from "inside users".
![image](/imgs/profile/feedback.jpg)

From these feedback, I learned **what didn't work out** in my initial prototypes:
...
- The top profile info summary card is not effective enough to express the uniqueness of a person.

### Design Decisions to Make Profile More "Human"

How could I add magic to the Profile to make it more personal, attractive and unique? I applied **cover photos**, which help set the tone and involve people in the design of their own profiles.

![image](/imgs/profile/iteration2.jpg)

On this stage, another major change I made was the layout. I used **2 columns layout** to create clearer structure. It was more consistent with other pages. Also, I tweaked some small UI elements like moving the name on top of the cover photo to the bottom of it since the previous solution caused legibility concerns.
...
3. **How about we combine the header and navigation tabs?** Yes it worked! The final solution hit a great balance between efficiency and volume. The experience was more smooth and responsive. (<strong><a href="https://www.zhihu.com/people/peipei55905" target="_blank">Click here</a></strong> to check online interaction)
