...
![image](/imgs/profile/feedback2.jpg)
...
- **Iteration 1**: The navigation tabs would stick to the top header when user scrolls the page. The problem was two bars sticking on the top of page took up too much space thus it was not friendly for users with smaller viewpoint screens.
