...
In just five years since 2011, Zhihu transformed from a small question & answer product to the largest knowledge sharing platform in China. By 2016, Zhihu had over 50 million users sharing their knowledge and experience. However, with the hyper-growth of the company, the usability of the web product was challenged, and it was also getting difficult for our team to know where to put new features because the product didn't have a clear information hierarchy. It was time for a redesign, both for ourselves and our users. In 2016, we decided to redesign our web product starting from the User Profile.
